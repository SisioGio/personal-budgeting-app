...
def create_scenario(event):
    ...
    if not code or not description:
        return generate_response(400, {"msg": "Both 'code' and 'description' are required."})
    ...
    return generate_response(201, {"msg": "Scenario created", "data": result})
...
def update_scenario(event):
    ...
    return generate_response(200, {"msg": "Scenario updated", "data": result})
...
def delete_scenario(event):
    ...
    return generate_response(200, {"msg": "Scenario deleted", "data": result})
