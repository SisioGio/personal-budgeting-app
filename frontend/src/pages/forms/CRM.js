  ...
  return (
    <div className="w-full  grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div className="bg-gray-900 p-6 rounded-2xl shadow-lg overflow-auto max-h-[420px]">
        <h1 className="text-2xl font-bold text-pink-400 mb-4">Initial Balance</h1>
        <InitialBalanceCard />
      </div>
      {/* Entries */}
      <div className="bg-gray-900 p-6 rounded-2xl shadow-lg overflow-auto max-h-[800px] col-span-2">
